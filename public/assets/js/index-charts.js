...
function ivDoughtnutChart(option) {
	if (option == 0) {
		var endpoint = `https://cbe-inv.herokuapp.com/charts/iv/week`;
	} else {
		var endpoint = `https://cbe-inv.herokuapp.com/charts/iv/${option}`;
...
function iiBarChart(option) {
	if (option == 0) {
		var endpoint = `https://cbe-inv.herokuapp.com/charts/ii/week`;
	} else {
		var endpoint = `https://cbe-inv.herokuapp.com/charts/ii/${option}`;
